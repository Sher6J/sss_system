...
<head>
    ...
    <title>数据 - 数据后台管理系统</title>
    <meta name="description" content="数据后台管理系统">
    <meta name="keywords" content="数据后台管理系统">
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 <a href="http://www.sher6j.cn">六甲</a>.</strong> All rights reserved.
    </footer>
    <!-- 底部导航 /-->
